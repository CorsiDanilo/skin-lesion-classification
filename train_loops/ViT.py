...
def train_eval_loop():
    ...
    data_name = f"ViT_pretrained_{current_datetime_str}"
...
def get_model():
    ...
    if RESUME:
        model.load_state_dict(torch.load(
            f"{ARCHITECTURE_VIT}_{FROM_EPOCH-1}.pt"))
