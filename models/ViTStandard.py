...
class ViT_standard(nn.Sequential):
    def __init__(self, in_channels, n_head, patch_size, d_model, img_size, n_layers, n_classes, dropout_p=DROPOUT_P):
        ...
        self.transformer_encoder = TransformerEncoder(
            img_size, in_channels, d_model, patch_size, n_layers, n_head, d_k, d_v, d_inner, dropout=dropout_p)
