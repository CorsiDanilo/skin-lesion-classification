...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        # src = torch.repeat_interleave(image_embeddings, tokens.shape[0], dim=0) #TODO: see if this is needed
        ...
        try:
            ...
            # print(
            # f"dense_prompt_embeddings shape is {dense_prompt_embeddings.shape}")
            src = src + \
                self.interpolate(dense_prompt_embeddings, *src.shape[2:])
